...
On utilise les points suivants détectés par la Kinect : le poignet, le millieu de la main et le sommet du pouce pour positionner et orienter le modèle en concordance avec les points détectés par la DLL.
...
On applique une rotation de l'angle calculé à l'armature du modèle, cela permet de retouver l'orientation de la main sur l'axe X et Y.
Une opération similaire est effectuée avec la base du pouce à la pace du millieu de la main pour touver l'orientation en Z: 
...
\begin{figure}[H]
 ...
 \caption{Schéma d'explication du calcul de l'angle aux joinutres de l'armature}
\end{figure}
