...
Il permet de trouver les poids adaptés à l'association entre les os de l'armature et les sommets (voir Tab. \ref{tab:repartitionPoid}). Pour rendre un résultat proche du réel, on souhaite que les poids possèdent certaines propriétés : \\
\begin{itemize}
