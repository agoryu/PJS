...
\chapter{Différents type de données}
...
\chapter{Modélisation de la main}
%input
...
\chapter{Détection de la main}
\section{Construction d'une ROI}
...
\chapter{Evaluation des solutions envisagées}