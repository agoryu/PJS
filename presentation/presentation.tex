...
\begin{document}
   ...
   \begin{frame}
    \begin{figure}
      \includegraphics[width=4cm]{images/hand_joints.png}
      \includegraphics[width=4cm]{images/exemple_hand_interact.jpg}
    \end{figure}
    \begin{figure}
      \centering
      \includegraphics[width=6cm]{images/skeletal-hand-model.jpg}
    \end{figure}
  \end{frame}
  ...
  \frame{\titlepage}
   ...
   \begin{frame}
 	...
 	\begin{frame}
 	  ...
 	  \begin{figure}
 	    \begin{center}
 	      \includegraphics[width=9cm]{images/MethodeModelisation.png}
 	      \label{fig:modelisation}
 	    \end{center}
 	  \end{figure}
 	  \begin{figure}
 	    \begin{center}
 	      \includegraphics[width=6cm]{images/FormuleEnergie.png}
 	      \label{fig:modelisationForm}
 	    \end{center}
 	  \end{figure}
